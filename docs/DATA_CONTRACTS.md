...
| Source | Expected |
|--------|----------|
| `build.ps1` default | `1.4.4.0` |
| `README.md` | `1.4.4.0` |
| Email Reviewer assembly/file version | `1.4.4.0` |
| Pester build and release tests | `1.4.4.0` |

Release 1.4.4.0 is aligned across source defaults, documentation, executable metadata, package naming, and release verification.
