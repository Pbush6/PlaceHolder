...
Assert-SourceContains -Path $core -Snippet 'function Write-TeamsDatabase' -Label 'core writer Write-TeamsDatabase'
...
Assert-SourceContains -Path $core -Snippet 'function Register-TeamsReportProtocolHandler' -Label 'core helper Register-TeamsReportProtocolHandler'
Assert-SourceContains -Path $core -Snippet 'function Resolve-PathInPstDownloadsFolder' -Label 'core helper Resolve-PathInPstDownloadsFolder'
...
Assert-SourceContains -Path $launcher -Snippet 'function Resolve-PathInPstDownloadsFolder' -Label 'launcher helper Resolve-PathInPstDownloadsFolder'
